...
export const NOMINATIONS_PERSONAL: Nomination[] = [
  ...
  {
    text: 'Научная среда - выступление с лекцией о гигиене +10',
    value: 10,
  },
  {
    text: 'Научная среда - выступление в качестве спикера +15',
    value: 15,
  },
  {
  ...
  {
    text: 'Приведи друга - трудоустройство и прохождение испытательного срока +20',
    value: 20,
  },
  {
    text: 'Посещение всех встреч сообщества (книжный клуб) на протяжении всей игры (май-ноябрь) +20)',
    value: 20,
  },
  {
    text: 'Посещение всех встреч сообщества (волонтёрство) на протяжении всей игры (май-ноябрь) +20',
    value: 20,
  }
];
...
export const NOMINATIONS_TEAM = [
  ...
  {
    text: 'Свои люди - вовлеченность в сетевые активности и проекты (ежемесячно) +30',
    value: 30,
  },
  {
